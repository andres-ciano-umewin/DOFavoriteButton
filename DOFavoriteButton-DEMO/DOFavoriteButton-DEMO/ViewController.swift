...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        starButton.addTarget(self, action: #selector(tappedButton), forControlEvents: .TouchUpInside)
        ...
        heartButton.addTarget(self, action: #selector(tappedButton), forControlEvents: .TouchUpInside)
        ...
        likeButton.addTarget(self, action: #selector(tappedButton), forControlEvents: .TouchUpInside)
        ...
        smileButton.addTarget(self, action: #selector(tappedButton), forControlEvents: .TouchUpInside)
        self.view.addSubview(smileButton)
        
        self.heartButton.addTarget(self, action: #selector(tappedButton), forControlEvents: .TouchUpInside)
    }
